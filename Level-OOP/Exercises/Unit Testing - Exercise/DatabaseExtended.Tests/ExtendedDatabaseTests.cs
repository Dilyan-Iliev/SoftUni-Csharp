namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        {
            //Arrange
            this.extendedDatabase = new Database(this.people);
        ...
        public void ConstructorShouldThrowArgumentExceptionWhenPassedMoreThan16People()
        {
            ...
            //Assert
            Assert.That(() => this.extendedDatabase = new Database(people), Throws.ArgumentException
                                                                                          .With.Message
        ...
        {
            //Arrange
            this.extendedDatabase = new Database(new Person(35000583882, "Lazko_Lazkov"));
